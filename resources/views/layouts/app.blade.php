...
<div class="container-fluid p-0 d-flex">
    ...
    <div class=" d-lg-block d-none sidebar margin-top-76 padding-bottom-76">
            <ul class="py-4 list-unstyled when-hover-side">
                <li class="rounded-list position-relative sub-background py-3 pe-4  {{request()->is('services') ? 'active' : ''}} {{request()->is('/') ? 'active' : ''}} {{request()->is('services*')  ? 'active' : ''}}">
                ...
                <li class="rounded-list position-relative sub-background py-3 pe-4 {{request()->is('carts') ? 'active' : ''}}">
                    <a href="{{ route('carts') }}"
                       class="h5 font-22 text-decoration-none text-ddd d-block mb-0">
                ...
                <li class="rounded-list position-relative sub-background py-3 pe-4 {{request()->is('applicants') ? 'active' : ''}}">
                ...
                <li class="rounded-list position-relative sub-background py-3 pe-4 {{request()->is('notifications') ? 'active' : ''}}">
                    ...
                    <div class="col-md-12 d-lg-block d-none img-single">
                        @if(auth()->check())
                            <div class="dropdown d-inline-block">
                                ...
                                @php
                                    $notifications = \App\Models\Notification::whereHas('service', function ($q){
                                ...
                                <div class="dropdown d-inline-block">
                                    <button class="btn mx-0 position-relative" type="button" id="dropdownMenuButton3"
                                        ...
                                        <span class="position-absolute top-0 end-0 font-12 badge bg-danger rounded-circle">{{ $notifications->count() }}</span>
                                    </button>
                                    <ul class="dropdown-menu dropdown-menu-1 scroll-chat drop-notification border-0 shadow text-end"
                                        aria-labelledby="dropdownMenuButton2">
                                        @if($notifications->count())
                                            @foreach($notifications->take(4)->get() as $notification)
                                                <li class="px-2 pt-2 pb-2 border-bottom border-secondary"><a href="{{ route('services.show', ['token' => $notification->token]) }}">
                                            ...
                                            <li class="text-center py-2">
                                                <a href="{{ route('notifications') }}" class="text-muted">{{ __('Show All Notifications') }}</a>
                                            </li>
                                        @else
    ...
    <div class="container-fluid position-relative">
        ...
        <div class="main margin-top-76 padding-bottom-76 pt-3 mb-5">
            <div class="d-block bg-sub py-2 px-3 mb-3 rounded-3 shadow-lg">
                @if(request()->is('services') or request()->is('/'))
                <ol class="breadcrumb h6 mb-0 ">
                    <li class=""><img src="{{ asset('assets/images/home.png') }}" class="mx-2" alt="" width="25px" height="25px"></li>
                    <li class="breadcrumb-item my-auto"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
                    <li class="breadcrumb-item my-auto"><a href="{{ route('services') }}">{{ __('Services') }}</a></li>
                </ol>
                @elseif(request()->is('services*'))
                    <ol class="breadcrumb h6 mb-0 ">
                        ...
                        <li class="breadcrumb-item my-auto"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('services') }}">{{ __('Services') }}</a></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('services.show', ['token' => request('token')]) }}">{{ \App\Models\Service::where('token', request('token'))->first()->name_lang }}</a></li>
                    </ol>
                @elseif(request()->is('applicants'))
                    <ol class="breadcrumb h6 mb-0 ">
                        <li class=""><img src="{{ asset('assets/images/home.png') }}" class="mx-2" alt="" width="25px" height="25px"></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('applicants') }}">{{ __('Applicants') }}</a></li>
                    </ol>
                @elseif(request()->is('carts'))
                    <ol class="breadcrumb h6 mb-0 ">
                        <li class=""><img src="{{ asset('assets/images/home.png') }}" class="mx-2" alt="" width="25px" height="25px"></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('carts') }}">{{ __('Cart') }}</a></li>
                    </ol>
                @elseif(request()->is('profile'))
                    <ol class="breadcrumb h6 mb-0 ">
                        <li class=""><img src="{{ asset('assets/images/home.png') }}" class="mx-2" alt="" width="25px" height="25px"></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('profile') }}">{{ __('Profile') }}</a></li>
                    </ol>
                @elseif(request()->is('notifications'))
                    <ol class="breadcrumb h6 mb-0 ">
                        <li class=""><img src="{{ asset('assets/images/home.png') }}" class="mx-2" alt="" width="25px" height="25px"></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item my-auto"><a href="{{ route('notifications') }}">{{ __('Notifications') }}</a></li>
                    </ol>
                @endif
