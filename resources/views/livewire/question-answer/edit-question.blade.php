<div class="d-inline">
    <a class="btn btn-primary btn-sm rounded-circle" data-bs-toggle="modal" data-bs-target="#EditModalQuestion{{$question['id']}}" title="{{ __('Edit') }}" wire:click="QuestionEditOpenModal">
        <i class="fa fa-edit"></i>
    </a>
    <div wire:ignore.self class="modal fade"  id="EditModalQuestion{{$question['id']}}"  role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form class="mt-2" method="post" wire:submit.prevent="update">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">نص الاجابة</label>
